...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.3)", date = "2021-11-13")
public class SaturdayService {

  public interface Iface {

    public String vacuo() throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void vacuo(org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
    ...
    public void hello(String para, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_vacuo() throws org.apache.thrift.TException
    {
      vacuo_args args = new vacuo_args();
      sendBase("vacuo", args);
    }

    public String recv_vacuo() throws org.apache.thrift.TException
    {
      vacuo_result result = new vacuo_result();
      receiveBase(result, "vacuo");
      if (result.isSetSuccess()) {
        return result.success;
      }
      throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "vacuo failed: unknown result");
    }
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void vacuo(org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      vacuo_call method_call = new vacuo_call(resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class vacuo_call extends org.apache.thrift.async.TAsyncMethodCall {
      public vacuo_call(org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
      }

      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("vacuo", org.apache.thrift.protocol.TMessageType.CALL, 0));
        vacuo_args args = new vacuo_args();
        args.write(prot);
      ...
      public String getResult() throws org.apache.thrift.TException {
        ...
        return (new Client(prot)).recv_vacuo();
      }
    }
    ...
    public static class hello_call extends org.apache.thrift.async.TAsyncMethodCall {
      private String para;
      public hello_call(String para, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.para = para;
      }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> getProcessMap(Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      processMap.put("vacuo", new vacuo());
      processMap.put("add", new add());
      processMap.put("hello", new hello());
      return processMap;
    }

    public static class vacuo<I extends Iface> extends org.apache.thrift.ProcessFunction<I, vacuo_args> {
      public vacuo() {
        super("vacuo");
      }

      public vacuo_args getEmptyArgsInstance() {
        return new vacuo_args();
      }
      ...
      public vacuo_result getResult(I iface, vacuo_args args) throws org.apache.thrift.TException {
        vacuo_result result = new vacuo_result();
        result.success = iface.vacuo();
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class vacuo<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, vacuo_args, String> {
      public vacuo() {
        super("vacuo");
      }
      ...
      public void start(I iface, vacuo_args args, org.apache.thrift.async.AsyncMethodCallback<String> resultHandler) throws TException {
        iface.vacuo(resultHandler);
      }
    }
  ...
  public static class vacuo_args implements org.apache.thrift.TBase<vacuo_args, vacuo_args._Fields>, java.io.Serializable, Cloneable, Comparable<vacuo_args>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("vacuo_args");


    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new vacuo_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new vacuo_argsTupleSchemeFactory());
    }
...
;
    ...
    static {
      ...
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(vacuo_args.class, metaDataMap);
    }
     ...
     */
    public vacuo_args(vacuo_args other) {
    }

    public vacuo_args deepCopy() {
      return new vacuo_args(this);
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof vacuo_args)
        return this.equals((vacuo_args)that);
      return false;
    }

    public boolean equals(vacuo_args that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(vacuo_args other) {
    ...
    public String toString() {
      StringBuilder sb = new StringBuilder("vacuo_args(");
      boolean first = true;
    ...
    private static class vacuo_argsStandardSchemeFactory implements SchemeFactory {
      public vacuo_argsStandardScheme getScheme() {
        return new vacuo_argsStandardScheme();
      }
    }

    private static class vacuo_argsStandardScheme extends StandardScheme<vacuo_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, vacuo_args struct) throws org.apache.thrift.TException {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, vacuo_args struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class vacuo_argsTupleSchemeFactory implements SchemeFactory {
      public vacuo_argsTupleScheme getScheme() {
        return new vacuo_argsTupleScheme();
      }
    }

    private static class vacuo_argsTupleScheme extends TupleScheme<vacuo_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, vacuo_args struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
      }

      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, vacuo_args struct) throws org.apache.thrift.TException {
  ...
  public static class vacuo_result implements org.apache.thrift.TBase<vacuo_result, vacuo_result._Fields>, java.io.Serializable, Cloneable, Comparable<vacuo_result>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("vacuo_result");

    private static final org.apache.thrift.protocol.TField SUCCESS_FIELD_DESC = new org.apache.thrift.protocol.TField("success", org.apache.thrift.protocol.TType.STRING, (short)0);

    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new vacuo_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new vacuo_resultTupleSchemeFactory());
    }
    ...
    static {
      ...
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(vacuo_result.class, metaDataMap);
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public vacuo_result(vacuo_result other) {
      if (other.isSetSuccess()) {
        this.success = other.success;
      }
    }

    public vacuo_result deepCopy() {
      return new vacuo_result(this);
    }
    ...
    public vacuo_result setSuccess(String success) {
      this.success = success;
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof vacuo_result)
        return this.equals((vacuo_result)that);
      return false;
    }

    public boolean equals(vacuo_result that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(vacuo_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("vacuo_result(");
      boolean first = true;
    ...
    private static class vacuo_resultStandardSchemeFactory implements SchemeFactory {
      public vacuo_resultStandardScheme getScheme() {
        return new vacuo_resultStandardScheme();
      }
    }

    private static class vacuo_resultStandardScheme extends StandardScheme<vacuo_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, vacuo_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, vacuo_result struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class vacuo_resultTupleSchemeFactory implements SchemeFactory {
      public vacuo_resultTupleScheme getScheme() {
        return new vacuo_resultTupleScheme();
      }
    }

    private static class vacuo_resultTupleScheme extends TupleScheme<vacuo_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, vacuo_result struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, vacuo_result struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
